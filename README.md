# 🗡️ Granblue Automation Framework (v2.0)
...
## ✨ New in v2.0
* **Modular Architecture:** Strategies and core engine logic are now split into separate, clean files (`helpers.js`, `content.js`, `strategies/...`) for easy maintenance.
...
* **Dynamic UI Configurations:** The Side Panel now adapts to your selected routine, allowing you to input target Wait Times, Slime IDs, Event IDs, Summon IDs, and Summon Ranks without touching the code.
